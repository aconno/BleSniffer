 ...
 * @author aconno
 */
abstract class BleSnifferBaseFormat : AdvertisementFormat {
    ...
    protected val bleSnifferMaskBytesPosition: List<Int> = (0..9).toList()
    protected fun generateBleSnifferRequiredFormat(type: Byte) = listOf(
        0x02,
        0x01,
        0x04,
        0x1A,
